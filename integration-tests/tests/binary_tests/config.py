...
@dataclass(frozen=True)
class OLDIntegrationTestPathConfig:
...
class IntegrationTestLogs:
    ...
    #:
    tarball_url: str
    integration_test_path_config: InitVar[OLDIntegrationTestPathConfig]
    #:
    ...
    def __post_init__(self, integration_test_path_config: OLDIntegrationTestPathConfig) -> None:
...
class CompressionTestPathConfig:
    ...
    old_integration_test_path_config: InitVar[OLDIntegrationTestPathConfig]
    ...
    def __post_init__(self, old_integration_test_path_config: OLDIntegrationTestPathConfig) -> None:
        ...
        if 0 == len(test_name):
            ...
            raise ValueError(err_msg)
        test_root_dir = old_integration_test_path_config.test_root_dir
